...
public class SimpleColorDecoration extends RecyclerView.ItemDecoration {
    ...
    public SimpleColorDecoration setMargin(float margin) {
        this.margin = margin;
        return this;
    }

    //设置颜色
    public SimpleColorDecoration setColor(int color) {
        mPaint.setColor(color);
        return this;
    }

    //设置分割线高度
    public SimpleColorDecoration setDividerHeight(float height) {
