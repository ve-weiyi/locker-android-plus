package com.ve.module.locker.common.service
...
import com.ve.module.locker.common.service.model.ParsedStructure
import com.ve.module.locker.common.service.model.SimpleUserData
...
public class LockerAutoFillService : AutofillService() {
    companion object {
    ...
    private fun createRemoteView(appId: String, name: String, username: String): RemoteViews {
        return RemoteViews(packageName, R.layout.locker_item_autofill).apply {
