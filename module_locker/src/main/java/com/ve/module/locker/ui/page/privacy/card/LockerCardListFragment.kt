 ...
 * @Date 2022/4/8
 */
class LockerCardListFragment :
    BaseVmListFragment<LockerFragmentListPrivacyBinding, LockerPrivacyCardViewModel, PrivacyCard>() {
    ...
    override fun initListener() {
        ...
        mBinding.tvSearchText.setOnClickListener {
            LockerContainerActivity.start(
                mContext, LockerCardSearchFragment::class.java,null,null)
        }
    }
