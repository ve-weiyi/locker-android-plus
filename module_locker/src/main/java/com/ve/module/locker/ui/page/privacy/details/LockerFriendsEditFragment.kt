...
class LockerFriendsEditFragment:
    ...
    private lateinit var mPrivacyInfo: PrivacyFriendsInfo
    ...
    override fun initView(savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            ...
            if (data is PrivacyFriendsInfo) {
                mPrivacyInfo=data
                showAtFragment(mPrivacyInfo)
            } else {
                mPrivacyInfo= PrivacyFriendsInfo()
            }
        }
    }
    ...
    private fun showAtFragment(privacyInfo: PrivacyFriendsInfo) {
