 ...
 *
 * 保存的键值，从share preference 中取出
 */
object LockitSpKey {


    var mContext: Application = AppContextUtil.mContext
    val isDebug:Boolean=BuildConfig.DEBUG


    const val USERNAME_KEY = "lockit_username"
    const val PASSWORD_KEY = "lockit_password"
