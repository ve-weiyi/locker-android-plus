...
import com.ve.module.lockit.databinding.LockitFragmentDrawerBinding
 ...
 * @Date 2022/4/7
 */
class LockitDrawerFragment : BaseVmFragment<LockitFragmentDrawerBinding, LockitDrawerViewModel>() , View.OnClickListener {
    override fun attachViewBinding(): LockitFragmentDrawerBinding {
        return LockitFragmentDrawerBinding.inflate(layoutInflater)
    }
    ...
    override fun initListener() {
        ...
        mBinding.lockitLoginNow.setOnclickNoRepeatListener  {
        ...
        when(v?.id){
            ...
            R.id.icon_tag -> {
                LockitContainerActivity.start(
                    mContext,
                    LockitTagListFragment::class.java.name,
                    "标签管理"
                )
            }
            R.id.icon_folder -> {
                LockitContainerActivity.start(
                    mContext,
                    LockitFolderListFragment::class.java.name,
                    "文件夹管理"
                )
            }
