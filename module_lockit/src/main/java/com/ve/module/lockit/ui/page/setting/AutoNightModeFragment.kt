...
class AutoNightModeFragment : PreferenceFragmentCompat() {
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        setPreferencesFromResource(R.xml.lockit_pref_setting_autonight, rootKey)
        setHasOptionsMenu(true)

        autoNight = preferenceScreen.findPreference(LockitSpKey.SP_KEY_AUTO_NIGHT_START)!!
        autoDay = preferenceScreen.findPreference(LockitSpKey.SP_KEY_AUTO_NIGHT_END)!!
