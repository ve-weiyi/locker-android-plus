...
class LockitSettingActivity: BaseActivity<LockitActivitySettingBinding>(){
    ...
    companion object {
        ...
        fun start(context: Context, fragmentClassName: String?=null, title: String? = null, fragmentBundle: Bundle? = null) {
            Intent(context, LockitSettingActivity::class.java).run {
...
//                flags=Intent.FLAG_ACTIVITY_SINGLE_TOP
    ...
    override fun attachViewBinding(): LockitActivitySettingBinding {
    ...
    override fun initialize() {
        ...
        if(fragmentClassName.isEmpty()){
            ...
            transactionFragment(LockitSettingFragment::class.java.name,fragmentArguments)
        }else{
