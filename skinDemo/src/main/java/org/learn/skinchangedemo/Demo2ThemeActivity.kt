...
import org.learn.skinchangedemo.utils.LogUtil
import java.io.File
...
data class AttrView(val view: View, val attrs: MutableList<AttrItem> = mutableListOf()) {
    ...
    data class AttrItem(val attrName: String, val resId: Int)
...
class Demo2ThemeActivity : AppCompatActivity() {
    ...
    fun onAddView(view: View) {
        ...
        layoutFactory1.changAttrView(this, addAttr)

        textView.setOnClickListener {
            mLL.removeView(it)
        }
    }
    private val layoutFactory1=SkinFactory(this)

    private  var layoutFactory2 = object : LayoutInflater.Factory2 {
